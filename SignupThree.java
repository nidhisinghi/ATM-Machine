...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        JLabel cnumber = new JLabel("XXXX-XXXX-XXXX-4084");
        ...
        c7= new JCheckBox("I hereby declare that the above entered detaild are correct to the best of known");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== submit){
            ...
            try{
                ...
                String query3 = "insert into Balance values('"+cardNumber+"','"+pinnumber+"',0)";
